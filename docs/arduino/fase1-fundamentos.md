...
<Tabs>
  <TabItem value="conceptos" label="💡 Conceptos" default>

Debe poder explicar con sus propias palabras:
...
> *"¿Cómo saben las luces de la calle cuándo encenderse? ¿Quién les dice qué hacer?"*
> Arduino es exactamente eso: una pequeña computadora que le da instrucciones al mundo físico.

### Gancho narrativo
*"Hoy vas a escribir tu primera orden que el Arduino va a obedecer. No importa si te equivocas — los ingenieros se equivocan todo el tiempo y eso está bien."*

<Tabs>
  <TabItem value="sesion" label="📋 Flujo de sesión" default>
...
### El problema de la vida real
> *"Cuando conectas algo a la corriente equivocada, se quema. Los electricistas saben exactamente cuánta corriente necesita cada cosa. Hoy aprendemos eso."*

### Gancho narrativo
*"El LED interno de la placa está escondido. Hoy vas a poner tu propio LED donde tú quieras y hacerlo parpadear. Ese LED, ese circuito, es tuyo."*
...
| 10–20 min | Conocer el breadboard. Dibujar cómo están conectados los hoyos por dentro. Probar con el multímetro |
...
### El problema de la vida real
> *"En las apps de tu teléfono, cuando cambias el volumen, no reprograman toda la app. Hay un número guardado que cambian. Eso es una variable."*
...
Escribir la variable en un **post-it** y pegarlo junto a la computadora.
Cuando ella cambia el número, cambiar también el post-it.
...
- **Segundo LED** con su propio tiempo de encendido → dos variables independientes, se "desincroniza"
...
### El problema de la vida real
> *"Cuando una canción tiene un coro que se repite, el compositor no escribe la letra 4 veces. Escribe 'repetir coro ×4'. En programación, eso se llama bucle."*

### Gancho narrativo
*"Hoy vas a hacer que 3 LEDs se enciendan en secuencia, como las luces de un escenario. Y lo vas a hacer sin copiar y pegar el mismo código 30 veces."*
...
:::tip Sustituir LEDs por
- **LEDs rojo-amarillo-verde** → ya empieza a parecer un semáforo (anticipa sesión 8)
- **3 buzzers de distintas frecuencias** → hace una melodía simple de 3 notas
:::
...
### El problema de la vida real
> *"Cuando el semáforo detecta que no hay carros, cambia más rápido. Está tomando una decisión basada en información. Hoy hacemos eso."*

### Gancho narrativo
*"Hasta ahora el Arduino hace lo mismo sin importar nada. Hoy por primera vez va a reaccionar a ti."*
...
Sin presionar → pin HIGH (resistencia interna "tira" hacia arriba)
...
:::tip Sustituir el botón por
- **Dos cables de jumper** que hay que tocar entre sí → más dramático, más teatral
- **Sensor de inclinación (tilt sensor)** → el LED reacciona si la placa está inclinada
:::

:::tip Sustituir el LED por
...
- 🏰 *Destripando la Historia:* "El telégrafo funcionaba con puntos y rayas. ¿Puedes usar el botón para mandar un mensaje en Morse al LED?"
...
### El problema de la vida real
> *"En una receta, cuando dice 'haz la salsa', no escribe toda la receta ahí mismo. Te dice que vayas a la página 47. Las funciones son eso: instrucciones con nombre."*
...
### El problema de la vida real
> *"El regulador de luz de tu cuarto no tiene dos posiciones: encendido o apagado. Puede estar a la mitad. Los focos de teatro suben y bajan suavemente. Eso es lo que hacemos hoy."*

### Gancho narrativo
*"El Arduino no puede dar 'medio voltaje'. Pero tiene un truco muy inteligente: parpadea tan rápido que tu ojo no lo ve y parece que está atenuado. Ese truco se llama PWM."*
...
**Por sus intereses:**
- 🎵 *Música:* "En los conciertos, el técnico de luces sube y baja la intensidad. Tú eres la técnica de luces hoy. ¿Puedes hacer que el LED siga el ritmo de una canción?"
...
### El problema de la vida real
> *"Los semáforos inteligentes no solo cuentan tiempo: responden a las personas. El botón peatonal le dice al semáforo que alguien quiere cruzar. Hoy construyes uno de verdad."*
...
| 5–20 min | Ella arma el circuito completa: 4 LEDs + resistencias + botón |
...
En cualquier momento del ciclo:
  botón presionado → peatonEspera = true
...
- **Buzzer:** pitido lento durante el rojo, pitido rápido durante el verde peatonal (como los semáforos para personas con discapacidad visual)
...
- **Modo nocturno:** si hay poca luz (LDR) → solo el amarillo parpadea
:::
...
Antes de cerrar la sesión 8, verificar:

- [ ] El ciclo verde → amarillo → rojo funciona automáticamente
- [ ] El botón se puede presionar en cualquier momento del ciclo
- [ ] El semáforo atiende al peatón al **terminar** el ciclo (no interrumpe)
...
*Siguiente: [🟡 Fase 2 — Sensores](./fase2-sensores)*
