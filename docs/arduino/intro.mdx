...
sidebar_position: 1
description: "Plan completo de Arduino para Gaia — desde el primer LED hasta un robot seguidor de línea."
tags:
  - arduino
  - plan
  - fundamentos
...
# Plan de Estudios: Arduino para Gaia
...
El Zumo requiere sensores de borde, estrategia de combate, y lógica considerablemente más compleja. Puede ser el objetivo del segundo semestre o del año siguiente.
...
*Plan diseñado para Gaia con conocimientos básicos de programación · 2026*
