...
| Protoboard grande | 1 | 830 puntos |
...
**Materiales:** Arduino + brotoboard + 1 LED + resistencia 220Ω + jumpers + multímetro.
...
| 10–20 min | Conocer el brotoboard. Dibujar cómo están conectados los hoyos. Probar con el multímetro |
...
**Al salir de esta sesión sabe:** cómo armar un circuito en brotoboard, por qué existe la resistencia, polaridad del LED, cómo medir con el multímetro.
...
**Materiales:** Arduino + brotoboard + 3 LEDs de distintos colores + 3 resistencias 220Ω + jumpers.
...
**Materiales:** Arduino + brotoboard + 1 LED + resistencia 220Ω + 1 botón push + jumpers.
...
**Materiales:** Arduino + brotoboard + 1 LED en pin 9 + resistencia 220Ω. Opcional: LED RGB cátodo común.
