...
### 1. Copiar los docs
```bash
cp docs/arduino/intro.md           tu-proyecto/docs/arduino/intro.md
cp docs/arduino/fase1-fundamentos.md  tu-proyecto/docs/arduino/fase1-fundamentos.md
```
